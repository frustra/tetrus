...
(function() {
  ...
  Tetrus.GameController = (function(_super) {
    ...
    function GameController() {
      ...
      this.set('isServer', this.peer.get('isOfferer'));
    }
    ...
    GameController.prototype._negotiate = function() {
      ...
      return Tetrus.on('socket:message', function(message) {
        var candidate, setRemoteDescription, _i, _len, _ref2;
  ...
  Tetrus.LandingController = (function(_super) {
    ...
    function LandingController() {
      _ref2 = LandingController.__super__.constructor.apply(this, arguments);
      return _ref2;
    }
  ...
  Tetrus.LobbyController = (function(_super) {
    ...
    function LobbyController() {
      _ref3 = LobbyController.__super__.constructor.apply(this, arguments);
      return _ref3;
    }
